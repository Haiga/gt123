...
train_normalized_path = os.path.join(ds_normalized_path, "Norm.train.txt")
...
test_normalized_path = os.path.join(ds_normalized_path, "Norm.test.txt")
...
vali_normalized_path = os.path.join(ds_normalized_path, "Norm.vali.txt")
