...
home = r'D:\Colecoes\experimento_loss_risk\tables-apresent-3\temp'
...
methods = ['extgeoRisk*', 'geoRisk*', 'mlpextgeoRisk*', 'mlpgeoRisk*',
           # methods = ['geoRiskSpearmanLoss', 'geoRiskListnetLoss', 'lambdaLoss',
           'grisklmart', 'lmart',
           'lambdaLoss', 'lambdaLossmulti', 'listNet', 'listNetmulti', 'ordinal', 'ordinalmulti',
           'pointwise_rmse', 'pointwise_rmsemulti', 'spearmanLoss',
...
for v in ['lambdaLoss', 'lambdaLossmulti', 'listNet', 'listNetmulti', 'ordinal', 'ordinalmulti',
           'pointwise_rmse', 'pointwise_rmsemulti', 'spearmanLoss',
           'spearmanLossmulti']:
    methods.append("mlp" + v)
...
for vv in ['extgeoRisk*', 'geoRisk*']:
    print(vv)
    for method in methods:
        if method in ['extgeoRisk*', 'geoRisk*']:
            continue
        else:
            print(method, end="\t")
            for metric in metrics:
