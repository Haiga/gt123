...
methods = ['extgeoRisk*', 'geoRisk*',
           # methods = ['geoRiskSpearmanLoss', 'geoRiskListnetLoss', 'lambdaLoss',
           # 'grisklmart', 'lmart',
           'lambdaLoss', 'lambdaLossmulti0.001', 'listNet', 'listNetmulti0.001', 'ordinal', 'ordinalmulti0.001',
           'pointwise_rmse', 'pointwise_rmsemulti0.001', 'spearmanLoss',
           'spearmanLossmulti0.001',
           ]
# methods = ['extgeoRisk*', 'geoRisk*',
#            # methods = ['geoRiskSpearmanLoss', 'geoRiskListnetLoss', 'lambdaLoss',
#            'grisklmart', 'lmart',
