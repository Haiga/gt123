...
home = r'D:\Colecoes\experimento_loss_risk\tables-apresent-2\yahoo'
...
methods = ['extgeoRiskListnetLoss', 'extgeoRiskSpearmanLoss', 'geoRiskListnetLoss', 'geoRiskSpearmanLoss',
           ...
           # 'lambdaLossmulti', 'listNetmulti', 'ordinalmulti', 'pointwise_rmsemulti', 'spearmanLossmulti','CorrScoremulti',
           'lambdaLossmulti', 'listNetmulti', 'ordinalmulti', 'pointwise_rmsemulti', 'spearmanLossmulti',
           'grisklmart']
methods = ['extgeoRiskListnetLoss', 'extgeoRiskSpearmanLoss', 'geoRiskListnetLoss', 'geoRiskSpearmanLoss',
           # methods = ['geoRiskSpearmanLoss', 'geoRiskListnetLoss', 'lambdaLoss',
           'grisklmart',
           ...
           # 'lambdaLossmulti',
           'lambdaLossmulti45',
           'listNet', 'listNetmulti', 'ordinal', 'ordinalmulti',
    ...
    for metric in metrics:
        ...
        for fold in ['']:
            ...
            for method in methods:
                ...
                # if "lambdaLossmultifold1-" in fold_name:
                # if "ordinalmultifold1-" in fold_name or "lambdaLossmulti45fold1-" in fold_name:
                if "ordinalmultifold1-" in fold_name or "lambdaLossmulti45fold1-" in fold_name or "lambdaLossmulti43fold1-" in fold_name:
                # if "ordinalmultifold1-" in fold_name:
                # if "ordinalmultifold1-" in fold_name:#######
                # if "ordinalmultifold1-" in fold_name or "spearmanLossmultifold1-" in fold_name:
                # if "ordinalmultifold1-" in fold_name or "lambdaLossmultifold1-" in fold_name or "msemulti" in fold_name:
                # if "spearmanLossmultifold1-" in fold_name or "lambdaLossmultifold1-" in fold_name or "msemulti" in fold_name:
                # if "spearmanLossmultifold1-" in fold_name or "lambdaLossmultifold1" in fold_name or "ordinalmultifold1-" in fold_name:
                # if False:
