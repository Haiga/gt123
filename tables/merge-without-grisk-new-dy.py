...
home = r'D:\Colecoes\experimento_loss_risk\tables-apresent-4\web10k'

methods = [
    'extgeoRiskListnetLoss', 'extgeoRiskSpearmanLoss', 'geoRiskListnetLoss', 'geoRiskSpearmanLoss',
           # 'extgeoRisk*', 'geoRisk*',
           'grisklmart',
    #'lmart',
           'lambdaLoss', 'listNet', 'ordinal',
